var d=new Date()
var ld=new Date(d.getMonth()+1+"/"+(d.getDate()-1)+"/"+d.getFullYear())
var td=new Date(d.getMonth()+1+"/"+(d.getDate()+1)+"/"+d.getFullYear())
var ys=neka.Wordle.list[ld.toDateString()]
var ts=neka.Wordle.list[d.toDateString()]
var tts=neka.Wordle.list[td.toDateString()]
